...
export function TeamDetailPage() {
  ...
  return <>
    <PageHeader title={team.name} description="此处列出属于该 Team 的 Agent。Agent 只有选择共享资产后才会使用它。" action={<Button variant="outline" onClick={() => dispatch({ type: 'OPEN_DIALOG', dialog: { kind: 'organization', entity: 'team', id: team.id, mode: 'edit' } })}>编辑 Team</Button>} />
