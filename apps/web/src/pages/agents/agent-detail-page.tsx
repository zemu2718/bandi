...
import { EmptyState, EntityNotFound, EntityTabPanel, EntityTabs, FieldRow, MonoPath, PathActions, StatusBadge, toneForStatus } from '../../components/app/page'
...
function IdentityTab({ agent }: { agent: FullAgent }) {
  ...
  return <><section className="panel overflow-hidden"><TabHeader title="身份与职责" description="Team 归属不形成隐式权限。" editing={editing} onEdit={beginEdit} onCancel={cancel} onSave={save} canSave={!nameError} saveLabel={managedAvatar ? '保存' : '保存到当前页面'} />
